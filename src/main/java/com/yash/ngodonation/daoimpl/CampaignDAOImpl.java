...
public class CampaignDAOImpl implements CampaignDAO {
    ...
    public List<Campaign> getAllCampaigns() {
        System.out.println("inside getAllCampaigns getAllUsers");
        ...
        try(Connection connection = DBConnection.getConnection()) {
            ...
            while (rs.next()) {
                ...
                campaign.setFundRaised(rs.getString("fund_raised"));
...
//                    campaign.setTitle(rs.getString("title"));
//                    campaign.setDescription(rs.getString("description"));
//                    campaign.setFundRaised(rs.getString("fund_raise"));
//                    campaign.setTargetAmount(rs.getString("target_amount"));
//                    campaign.setStartDate(rs.getString("start_date"));
//                    campaign.setEndDate(rs.getString("end_date"));
//                }
...
//            pstmt.setString(3, campaign.getFundRaised());
